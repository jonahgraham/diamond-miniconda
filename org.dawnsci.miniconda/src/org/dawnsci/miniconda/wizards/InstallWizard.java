package org.dawnsci.miniconda.wizards;

import java.lang.reflect.InvocationTargetException;

import org.dawnsci.miniconda.MinicondaActivator;
import org.dawnsci.miniconda.InterpreterProvider;
import org.dawnsci.miniconda.installer.InstallOutputHandler;
import org.dawnsci.miniconda.installer.Installer;
			...
			if (realException instanceof CoreException) {
				...
				ErrorDialog.openError(getShell(), "Error when running Install",
						"An unexpected error occurred when running the install", new Status(IStatus.ERROR,
								MinicondaActivator.PLUGIN_ID, "Unexpected error", realException));
			}
			return false;
		}
